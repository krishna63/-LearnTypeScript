 ...
 */
var implicitStringVariable = 'based on my value, typescript set its variable type to string';
var explictStringVariable = 'explictly defining type variable';
/**
 * The same applies for the string, number and boolean
 */
var implicitNumberVariable = 10;
var explicitNumberVariable = 100;
var implictBooleanVariable = true;
var explictBooleanVariable = false;
